...
internal func gicEnableIRQ(_ irqID: UInt32) {
...
///
/// - Parameter irqID: The GIC interrupt ID (>= 32 for SPIs).
internal func gicDisableIRQ(_ irqID: UInt32) {
	let word = Int(irqID / 32)
	let bit = irqID % 32
...
@inline(__always)
internal func gicAcknowledge() -> UInt32 {
...
@inline(__always)
internal func gicEndOfInterrupt(_ irqID: UInt32) {
